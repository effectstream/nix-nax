...
// that the calls fit the node's per-tx budget. 11 is the MEASURED maximum:
// settle16 (k=18) was rejected at dispatch with 1010 Custom(168) on node
// 1.0.0 (verification weight over budget), and settle12 also compiles to
// k=18 — 11 is the largest size that stays k=17.
//
