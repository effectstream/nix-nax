...
## Check the advanced topic

The advanced topic is optional and separate from the browser game's main
contract. Compile its complete and stub contracts, verify its own generated
keys, then run its TypeScript and simulator checks:
...
deployment or its deployment JSON. It is not wired into the browser game.
